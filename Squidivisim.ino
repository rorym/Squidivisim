...
void loop() {
  ...
  if (millis() - nextLSMcheck > 200) {
     ...
     if (colourSample == 0) {
       ...
       if (millis() - nextAccelPattern > 1000) {
         // run the colour fade function
         colourFade(abs(accelAverageX),abs(accelAverageY),abs(accelAverageZ));
